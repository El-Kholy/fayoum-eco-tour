/* =========================================
   JS - المعبد الشمالي | Fayoum Eco Tours
   ========================================= */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ar: {
      ...
      title: "المعبد الشمالي",
      subtitle: "اكتشف سحر النقوش وهدوء الأطلال في قلب المعبد الشمالي",
      bestTime: "أفضل وقت", distance: "المسافة", entry: "الدخول", rating: "التقييم",
      aboutTitle: "عن المكان",
      aboutText: 'المعبد الشمالي في منطقة كرانيس الأثرية (كوم أوشيم بالفيوم) هو معبد يوناني روماني بني من الحجر الجيري في أوائل القرن الأول الميلادي تقريباً، ويبعد حوالي 200 متر عن المعبد الجنوبي. يقع المعبد على تلة مرتفعة، وكان مخصصاً غالباً لعبادة إله التمساح "سوخوس" (سوبك)، ويتميز بتخطيط مصري قديم مع لمسات يونانية رومانية، ومبني من الحجر الجيري بخلاف بيوت المدينة المبنية من الطوب اللبن.',
    ...
    en: {
      ...
      subtitle: "Discover the magic of inscriptions and the tranquility of ruins at the heart of the Northern Temple",
      bestTime: "Best Time", distance: "Distance", entry: "Entry", rating: "Rating",
      aboutTitle: "About the Place",
      aboutText: 'The Northern Temple in the Karanis archaeological area (Kom Oshim, Fayoum) is a Greco-Roman temple built from limestone in the early 1st century AD, located about 200 meters from the Southern Temple. The temple sits on an elevated hill and was likely dedicated to the crocodile god "Sobek". It features an ancient Egyptian layout with Greco-Roman touches, built from limestone unlike the mud-brick houses of the surrounding city.',
  ...
  const tabsData = {
    'tab-time': {
      ar: {
        ...
        items: [
          ...
          '<i class="fa-solid fa-circle-check"></i> <strong>الصباح الباكر (8 – 11 ص):</strong> إضاءة طبيعية مثالية للتصوير',
          '<i class="fa-solid fa-circle-check"></i> <strong>قبيل الغروب:</strong> ألوان دافئة تُبرز تفاصيل النقوش',
      ...
      en: {
        ...
        items: [
          '<i class="fa-solid fa-circle-check"></i> <strong>October – March:</strong> Mild weather, ideal for exploring the ruins',
          '<i class="fa-solid fa-circle-check"></i> <strong>Early morning (8 – 11 AM):</strong> Perfect natural lighting for photography',
          '<i class="fa-solid fa-circle-check"></i> <strong>Before sunset:</strong> Warm colors highlight the details of the inscriptions',
    ...
    'tab-distance': {
      ar: {
        ...
        items: [
          '<i class="fa-solid fa-plane-arrival"></i> المطار ← المعبد الشمالي: <strong>~105 كم</strong>',
      ...
      en: {
        ...
        items: [
          '<i class="fa-solid fa-plane-arrival"></i> Airport → Northern Temple: <strong>~105 km</strong>',
    ...
    'tab-entry': {
      ...
      en: {
        ...
        items: [
          ...
          '<i class="fa-solid fa-ban"></i> <strong>Prohibited:</strong> Touching inscriptions, flash photography, smoking, eating inside',
          '<i class="fa-solid fa-clock"></i> Opening hours: 9 AM – 4 PM daily'
        ]
      }
    },
    'tab-rating': {
      ar: { title: '<i class="fa-solid fa-star"></i> قيّم المعبد الشمالي' },
      en: { title: '<i class="fa-solid fa-star"></i> Rate the Northern Temple' }
    }
  };
